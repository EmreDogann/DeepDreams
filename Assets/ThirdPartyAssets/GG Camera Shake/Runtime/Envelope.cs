    ...
    public class Envelope : IAmplitudeController
    {
        ...
        public void Update(float deltaTime)
        {
            ...
            else
            {
                ...
                {
                    if (controlMode == EnvelopeControlMode.Auto && Time.time > sustainEndTime) SetTarget(0);
                }
            }
        ...
        {
            if (controlMode == EnvelopeControlMode.Manual && !finishWhenAmplitudeZero) SetTarget(value);
        }
