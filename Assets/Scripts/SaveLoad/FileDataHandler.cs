...
namespace DeepDreams.SaveLoad
{
    public class FileDataHandler
    {
        ...
        public void AddFile(string dataDirPath, string dataFileName, bool useEncryption, string dataObjectId)
        {
            ...
            FileInfo fileInfo = new FileInfo(dataDirPath, dataFileName, Path.Combine(dataDirPath, dataFileName),
                useEncryption);
        ...
        public void Save(SaveObject data)
        {
            ...
            try
            {
                ...
                string dataToStore = JsonConvert.SerializeObject(data.saveData, Formatting.Indented);
