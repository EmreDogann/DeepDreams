...
{
    [Serializable]
    public class SaveDataFieldReference<T> where T : SaveData
    {
        ...
        {
            fieldInfoArray =
                typeof(T).GetFields(BindingFlags.DeclaredOnly | BindingFlags.Public | BindingFlags.Instance);
            ...
            {
                fieldsNamesList.Add(
                    fieldInfoArray[i].Name + " (" + ParseTypeToString(fieldInfoArray[i].FieldType) + ")");
            }
