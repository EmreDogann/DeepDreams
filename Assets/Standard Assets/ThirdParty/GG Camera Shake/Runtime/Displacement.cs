...
namespace DeepDreams.ThirdPartyAssets.GG_Camera_Shake.Runtime
{
    ...
    public struct Displacement
    {
        ...
        public static Displacement Zero => new Displacement(Vector3.zero, Vector3.zero);
        ...
        public Displacement Normalized => new Displacement(position.normalized, eulerAngles.normalized);
